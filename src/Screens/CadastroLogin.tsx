               ...
               >
                  ...
                  >
                     ...
                     <CustomTextField
                        ...
                        error={
                           !!stateLocal.loginDTO.login && !isValidEmail(stateLocal.loginDTO.login)
                        }
                        errorMessage="nada"
                        label="Email"
                        sx={{
                     ...
                     <CustomTextField
                        ...
                        error={
                           !!stateLocal.loginDTO.login && !isValidEmail(stateLocal.loginConfirmed)
                        }
                        errorMessage="nada"
                           ...
                           input: {
                              endAdornment: (
                                 <CustomIcon
                                    id=""
                                    className={
                                       stateLocal.visible ? 'fas fa-eye' : 'fas fa-eye-slash'
                                    }
                                    color="black"
                                    border="100%"
                                    padding="10px"
