...
const NovaEscola = (props: TNovaEscola) => {
      ...
      return (
            <>
                  {stateLocal.tipoTela === TipoTelaEscola.NOVAESCOLA && (
                        <>
                              <CustomDrawer title="Voltar" onGoBack={onGoBack} />
                              <Box
                                    sx={{
                                          display: 'flex',
                              ...
                              >
                                    ...
                                    <FormControl>
                                          <TextField
                                                ...
                                                helperText={
                                                      stateLocal.error.cep ? 'Informe o CEP seu Animal' : ''
                                                }
                                          />
                                    </FormControl>
                  ...
                  {stateLocal.tipoTela !== TipoTelaEscola.NOVAESCOLA && <Escola />}
            </>
      );
};
