...
const Escola = () => {
    ...
    const handleMenuClose = () => {
        setStateLocal((prevState) => ({ ...prevState, anchorEl: null, escolaSelecionada: null }));
    };

    const columns: GridColDef[] = [
        { field: 'nome', headerName: 'Escola', width: 150, headerAlign: 'left' },
        { field: 'cidade', headerName: 'Cidade', width: 150, headerAlign: 'left' },
        { field: 'estado', headerName: 'Estado', width: 150, headerAlign: 'left' },
        { field: 'cep', headerName: 'Cep', width: 150, headerAlign: 'left' },
        {
            field: 'pessoas',
    ...
    const getEscolas = useCallback(async () => {
        try {
            ...
            console.log('aqui', isLoading.current);
            setStateLocal((prevState) => ({ ...prevState, escolas: data }));
        } catch (err) {
    ...
    return (
        <>
            {/* <Box>
                <Button onClick={onNavigateEscola}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'end' }}>
                <Button
                    ...
                    sx={{ borderRadius: '50px', bgcolor: 'purple', color: 'whitesmoke' }}
                >
                    <Typography sx={{ fontWeight: 'bold' }}>NOVA ESCOLA</Typography>
                </Button>
            </Box>
